...
-- Insert data into a table
INSERT INTO properties(user_id, street, city, state, zip, mortgage_amount, vacancy, renter_name, renter_number, renter_email, lease_term, rent_amount, rent_status)
VALUES (1, '14 Forrest Hills Dr', 'Atlanta', 'Ga', '30362', 2200, 'Occupied', 'John & Laura', '465-887-2304', 'John@gmail.com', '6/20/23 - 6/20/25', 3000, 'Past Due');
